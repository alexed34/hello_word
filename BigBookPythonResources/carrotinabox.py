...
Это простой и глупый блеф для
два человека-игрока. У каждого игрока есть ящик.
В одной коробке есть морковь, и каждый игрок
хочет морковь. Первый игрок смотрит
в свою коробку, а затем говорит второму игроку, что они
либо есть, либо нет моркови. Второй игрок
получает возможность решать, менять ли ящики местами или нет.
